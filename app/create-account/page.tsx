  ...
  return (
    <div className="flex flex-col gap-10 py-8 px-6">
      ...
      <form className="flex flex-col gap-3">
        <FormInput required placeholder="Username" errors={[]} />
        <FormInput required type="email" placeholder="Email" errors={[]} />
        <FormInput required type="password" placeholder="Password" errors={[]} />
        <FormInput required type="password" placeholder="Password confirm" errors={[]} />
